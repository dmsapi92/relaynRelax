...
export const ENV = {
  MASTER_DATABASE_URL:
    ...
    "mongodb://DmsAdmin:Whatthefq101@156.67.219.236:27017/relynrelaxMasterDB?replicaSet=rs0&authSource=DMS",
  USER_DATABASE_URL_TEMPLATE:
    process.env.USER_DATABASE_URL_TEMPLATE ||
    "mongodb://DmsAdmin:Whatthefq101@156.67.219.236:27017/{dbname}?replicaSet=rs0&authSource=DMS",
